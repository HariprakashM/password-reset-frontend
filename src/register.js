      ...
      <div className='row mt-5'>
        ...
        <div className='col-lg-4 justify-content-center'>
          ...
          <div className="form-group mt-2">
              ...
              {/* <input type="text" className="form-control"   id="User Name" placeholder="User Name" name="username" value='one' onChange={formik.handleChange}/> */}
            </div>
            <div className="form-group mt-2">
            ...
            <div className="form-check mt-2">
              <input type="checkbox" className="form-check-input" id="exampleCheck1"/>
                <label className="form-check-label" for="exampleCheck1">I agree with terms and condition</label>
            </div>
            <input type="submit" value='Signup' className="btn btn-success  mt-2 "/>
            <div className="form-group mt-1">
            <label>Already have an account?<Link style={{color:"blue"}} to='/'> Login</Link></label>
            </div>
          </form>
        </div>
      </div>
